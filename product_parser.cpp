...
{
    Book* bookObj = new Book(prodName_, price_, qty_, isbn_, author_);
    return bookObj;
}
...
{
    Clothing* clothingObj = new Clothing(prodName_, price_, qty_, size_, brand_);
    return clothingObj;
}
...
{
    Movie* movieObj = new Movie(prodName_, price_, qty_, genre_, rating_);
    return movieObj;
}
